...
<div class="sidebar">
    ...
    <div>
        <a href="admin/service.html" class="collapsible">Service</a>
    </div>
    <div>
        <a href="admin/user.html" class="collapsible">User</a>
    </div>
    <div>
                    ...
                    <div class="row tm-edit-product-row">
                        ...
                        <form action="MainController" class="tm-edit-product-form" method="post">
                            ...
                            <div class="form-group mb-3">
                                <label class="title-lable mt-3" for="name">Product
                                </label>
                            ...
                            <div class="row" style="display: none;" id="date_form">
                                <div class="form-group mb-3 col-xs-12 col-sm-6">
                                    <label for="import_date" class="title-lable">ImportDate
                                    </label>
                                    <input id="import_date" name="import_date" type="date" class="form-control validate"
                                           data-large-mode="true" />
                                </div>
                                <div class="form-group mb-3 col-xs-12 col-sm-6">
                                    <label for="expire_date" class="title-lable">ExpriredDate
                                    </label>
