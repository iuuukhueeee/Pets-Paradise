            ...
            <div class="container">
                <ul class="responsive-table">
                    <li class="table-header">
                        ...
                        <div class="col col-5 text-center">Phone</div>
                        <div class="col col-6">RoleID</div>
                    ...
                    <li class="table-row">
                        ...
                        <div class="col col-5" data-label="Phone">0123456789</div>
                        <div class="col col-6" data-label="RoleID">Admin</div>
