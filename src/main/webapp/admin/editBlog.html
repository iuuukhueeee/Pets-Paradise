        ...
        <div class="container">
            ...
            <div class="container">
                <ul class="responsive-table">
                    ...
                    <div class="col col-5" data-label="Description">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Accusantium aut quia enim dignissimos voluptatibus eligendi, laborum natus vel incidunt perspiciatis?</div>
                    <div class="col col-6" data-label="Action">
                        <i class="fa-solid fa-arrow-up" style='font-size:24px; cursor: pointer;'></i>
