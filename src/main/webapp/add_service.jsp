...
<body>
    ...
    <div class="wrapper">
        <form action="MainController" method="post">
            ...
            <div class="">
                <input autocomplete="off" type="text" class="form-control" placeholder="Service Description" name="serviceDescription">
            </div>
            </br>
    ...
    <form action="MainController">
        <input name="SearchService" placeholder="Service title" type="text"/>
        ...
        <table border="2" class="table table-striped table-bordered" style="box-sizing: border-box">
            ...
            <form action="MainController" method="POST">
                <tr>
                    ...
                    <td>
                        <input type="text" name="ServicePrice" value="<%= service.getServicePrice()%>" required="" size="5"/>
                    </td>
                    <td>
                        <input type="text" name="ServiceDescription" value="<%= service.getServiceDescription()%>" required="" size="14"/>
                    </td>
