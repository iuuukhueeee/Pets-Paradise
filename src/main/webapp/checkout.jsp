...
<%
    ...
    List<CartDTO> cart = cartDAO.getItemOnCartByUsername(user.getUsername());
    for (int i = 0; i < cart.size(); i++) {
        String itemID = cart.get(i).getItemID();
        String[] type = itemID.split("-");
%>
            ...
            <div class="flex shadow-md my-10 cart">
                <div class="w-3/4 bg-white px-10 py-10 item">
                    <div class="flex justify-between border-b pb-8">
                        ...
                        <h2 class="font-semibold text-2xl"><%=cart.size()%></h2>
                    </div>
...
<%--                    </div>--%>
                    ...
                    <a href="shopping.html" class="flex font-semibold text-indigo-600 text-sm mt-10">
