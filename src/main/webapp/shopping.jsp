            ...
            <form>
                <div class="flex">
                    ...
                    <button id="dropdown-button" data-dropdown-toggle="dropdownId"
                        ...
                        type="button"> Categories <svg class="ml-1 w-4 h-4" fill="currentColor" viewBox="0 0 20 20"
                            xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd"
                    ...
                    <div id="dropdownId" class="hidden z-10 w-44 rounded divide-y divide-gray-100 shadow dark:bg-white"
                        ...
                        <ul class="py-1 text-sm text-black dark:text-black" aria-labelledby="dropdown-button">
                            <li data-dropdown-toggle="dropdownId">
                                <button type="button"
                                    class="inline-flex py-2 px-4 w-full hover:bg-gray-100 dark:hover:bg-[#a5d0cc] dark:hover:text-white">Food</button>
                            </li>
                            <li data-dropdown-toggle="dropdownId">
                                <button type="button"
                                    class="inline-flex py-2 px-4 w-full hover:bg-gray-100 dark:hover:bg-[#a5d0cc] dark:hover:text-white">Accessories</button>
                            </li>
                            <li data-dropdown-toggle="dropdownId">
                                <button type="button"
                                    class="inline-flex py-2 px-4 w-full hover:bg-gray-100 dark:hover:bg-[#a5d0cc] dark:hover:text-white">Gel</button>
                            </li>
                            <li data-dropdown-toggle="dropdownId">
                                <button type="button"
                                    class="inline-flex py-2 px-4 w-full hover:bg-gray-100 dark:hover:bg-[#a5d0cc] dark:hover:text-white">Stuffs</button>
                            </li>
                            <li data-dropdown-toggle="dropdownId">
                                <button type="button"
                                    class="inline-flex py-2 px-4 w-full hover:bg-gray-100 dark:hover:bg-[#a5d0cc] dark:hover:text-white">Toys</button>
                            </li>
                        </ul>
                    </div>
                    <div class="relative w-full">
                        ...
                        <button type="submit"
                            class="absolute top-0 right-0 p-2.5 text-sm font-medium text-white bg-blue-700 rounded-r-lg border border-[#68A7AD] dark:bg-[#68A7AD] dark:hover:bg-[#68A7AD]dark:focus:ring-[#68A7AD]"><svg
            ...
            <div class="col">
                <div class="item">
                    ...
                    <div class="blog-content">
                        <ul>
                            <li><i class="fa-solid fa-calendar"></i>2022/04/05</li>
                        </ul>
