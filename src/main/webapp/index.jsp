...
<body>
    ...
    <%
        List<ServiceDTO> list = (List<ServiceDTO>) request.getAttribute("SERVICES");
...
<section class="services animate__animated animate__bounce">
    <div class="container">
        <h1>Services</h1>
        <p>At Pet's Paradise, we serve pets of every type, age, and phase of life because we truly love animals. We show
            it
            with every belly rub, long walk, scratch behind the ear, and treat we give. We’d love to be your trusted
            sidekick
            for a healthy and happy pet because we know we can deliver trusted, quality care and a professional,
            stress-free
        ...
        <div class="container">
            <div class="row">
                <div class="col-md">
                    ...
                    <div class="item">
                        <h4>Vaccinate</h4>
                        <p> Our medical administrators are experienced with pills, shots, injections, and fluids and can
                            ensure that
                ...
                <div class="col-md">
                    ...
                    <div class="item">
                        <h4>Special Care</h4>
                        <p>Any time you schedule services thereafter, you’ll receive care from your primary sitter. If
                            the primary
                ...
                <div class="col-md">
                    ...
                    <div class="item">
                        <h4>Expert</h4>
                        <p>You will receive professional advice from doctors and experts to provide a reasonable
                            treatment method
                            for your pets.</p>
                    </div>
                </div>
        ...
        <div class="row">
            ...
            <div class="col-md">
                <div class="content">
                    ...
                    <p>
                        Everything we do is driven from our love of animals and our commitment to pet health. We offer
                        one
                        budget-friendly pet insurance plan that covers vet visits for new accidents and illnesses. It
                        makes it
                        ...
                        <div class="carousel-caption d-md-block">
                            <div class="top animation-item-3 wow">
                                ...
                                <p>My new site is so much faster and easier to work with than my old site. They are here
                                    to help the
                                    customers to get their success. Nemo sit eos, quod minus eius illo labore. Pellen
                                    tesque libero ut
                                    justo, ultrices
                                    in ligula.</p>
                            </div>
                    ...
                    <div class="carousel-item text-center">
                        ...
                        <div class="carousel-caption d-md-block">
                            <div class="top">
                                <i class="fa-solid fa-quote-left"></i>
                                <h1>OMG! I cannot believe. It's Awesome "</h1>
                                    <p>The services provided by Pet's Paradise and excellent. They are extremely
                                        reliable and
                                        communicative. It
                                        is evident how much they care for our dogs and attentive to their individual
                                        needs. Tom is the
                    ...
                    <div class="carousel-item text-center">
                        ...
                        <div class="carousel-caption d-md-block">
                            <div class="top">
                                <i class="fa-solid fa-quote-left"></i>
                                <h1>OMG! I cannot believe. It's Awesome "</h1>
                                    <p>I couldn’t be happier with the service I really didn’t want to leave my dog but I
                                        felt like I
                                        could trust Walter with my dog. He took such good care of her and sent us
                                        pictures and updates the
                                        whole time. My dog was cared for the way she would be cared for at home. I
...
<section class="pricing-plan animate__animated animate__fadeIn" style="animation-duration: 6s;">
    <header>
        <h1>Pricing Plan</h1>
        <P>The choice is the door to the customer's heart, we always have the optimal service package for you in the
            most
            perfect way.</P>
    </header>
    <div class="container">
        <div class="row row-cols-4">
            <div class="col">
                <div class="item">
                    <div class="title">
                        <h4><%=list.get(0).getServiceName()%></h4>
                    </div>
                    <button class="price btn btn-danger"><%=list.get(0).getServicePrice()%></button>
                    <div class="body">
                        <div class="container">
                            <ul>
            ...
            <div class="col">
                <div class="item">
                    <div class="title">
                        <h4><%=list.get(1).getServiceName()%></h4>
                    </div>
                    <button class="price btn btn-danger"><%=list.get(1).getServicePrice()%></button>
                    <div class="body">
                        <div class="container">
                            <ul>
                                <li>Bath (Hypo-Allergenic)</li>
            ...
            <div class="col">
                <div class="item">
                    <div class="title">
                        <h4><%=list.get(2).getServiceName()%></h4>
                    </div>
                    <button class="price btn btn-danger"><%=list.get(2).getServicePrice()%></button>
                    <div class="body">
                        <div class="container">
                            <ul>
                                <li>Bath (Hypo-Allergenic)</li>
            ...
            <div class="col">
                <div class="item">
                    <div class="title">
                        <h4><%=list.get(3).getServiceName()%></h4>
                    </div>
                    <button class="price btn btn-danger"><%=list.get(3).getServicePrice()%></button>
                    <div class="body">
                        <div class="container">
                            <ul>
                                <li>Bath (Hypo-Allergenic)</li>
